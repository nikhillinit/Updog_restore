...
export class ShadowIntelligence {
  ...
  private isConsistentImprovement(v1: ReservesResult, v11: ReservesResult): boolean {
    ...
    const v1Utilization =
      v1.data.metadata.total_allocated_cents / v1.data.metadata.total_available_cents;
    const v11Utilization =
      v11.data.metadata.total_allocated_cents / v11.data.metadata.total_available_cents;
