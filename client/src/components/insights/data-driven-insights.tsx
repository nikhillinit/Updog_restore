...
export function DataDrivenInsights({ className }: DataDrivenInsightsProps) {
  ...
  const workflows = [
    {
      ...
      description:
        'Live forward-looking view combining actual investments and construction projections',
      status: workflowInsights.currentForecast.status,
      metrics: [
        {
          label: 'Projected TVPI',
          value: `${workflowInsights.currentForecast.tvpiProjected}x`,
          trend: 'up',
        },
        {
          label: 'Actual TVPI',
          value: `${workflowInsights.currentForecast.tvpiActual}x`,
          trend: 'up',
        },
    ...
    },
    {
      ...
      description:
        'Track deployment pacing, market conditions, and investment terms vs projections',
      status: workflowInsights.pacing.onTrack ? 'on-track' : 'needs-attention',
      metrics: [
        {
          label: 'Deals Made',
          value: workflowInsights.pacing.dealsPaced.toString(),
          trend: 'neutral',
        },
        {
          label: 'Projected Total',
          value: workflowInsights.pacing.dealsProjected.toString(),
          trend: 'neutral',
        },
        {
          label: 'Capital Deployed',
          value: `${(workflowInsights.pacing.capitalDeployed * 100).toFixed(0)}%`,
          trend: 'up',
        },
      ],
    ...
    },
    {
      ...
      metrics: [
        {
          label: 'Companies',
          value: workflowInsights.scenarios.portfolioCompanies.toString(),
          trend: 'neutral',
        },
        {
          label: 'Scenarios Built',
          value: workflowInsights.scenarios.scenariosBuilt.toString(),
          trend: 'up',
        },
        {
          label: 'Avg Cases/Deal',
          value: workflowInsights.scenarios.averageCases.toFixed(1),
          trend: 'neutral',
        },
      ],
    ...
    },
    {
      ...
      description:
        'Follow-on MOIC analysis ranking portfolio companies by expected return on next $1',
      status: 'optimized',
      metrics: [
        {
          label: 'Total Reserves',
          value: `$${(workflowInsights.reserves.totalReserves / 1000000).toFixed(1)}M`,
          trend: 'neutral',
        },
    ...
    },
    {
      ...
      metrics: [
        {
          label: 'Opportunities',
          value: workflowInsights.partialSales.opportunities.toString(),
          trend: 'neutral',
        },
        {
          label: 'Attractive Sales',
          value: workflowInsights.partialSales.attractiveDeals.toString(),
          trend: 'up',
        },
        {
          label: 'Avg Premium',
          value: `${workflowInsights.partialSales.avgPremium}%`,
          trend: 'down',
        },
      ],
    ...
    },
    {
      ...
      metrics: [
        {
          label: 'Companies',
          value: workflowInsights.kpis.companiesTracked.toString(),
          trend: 'neutral',
        },
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'opportunities':
        return (
          <Badge className="bg-orange-100 text-orange-800 border-orange-200">Opportunities</Badge>
        );
