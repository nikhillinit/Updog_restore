...
const SAMPLE_DATA: PortfolioCostValueData[] = [
  ...
  },
  {
    ...
    costBasis: 49500000,
    realizedValue: 3800000,
    unrealizedValue: 55500000,
    totalValue: 59300000,
  },
  {
    month: 'Jul 2023',
    costBasis: 51000000,
    realizedValue: 6200000,
    unrealizedValue: 58200000,
    totalValue: 64400000,
  },
  {
    month: 'Aug 2023',
    costBasis: 52800000,
    realizedValue: 8552632,
    unrealizedValue: 56944681,
    totalValue: 65497313,
  },
];
...
const CustomTooltip = ({
  ...
  active?: boolean;
  payload?: Array<{ payload: PortfolioCostValueData }>;
  label?: string;
}) => {
...
export default function PortfolioCostValueChart() {
  ...
  const latestData =
    SAMPLE_DATA.length > 0
      ? SAMPLE_DATA[SAMPLE_DATA.length - 1]
      : { realizedValue: 0, unrealizedValue: 0 };
      ...
      <CardContent>
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={SAMPLE_DATA} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
              ...
              <XAxis
                ...
                stroke="#666"
              />
              <YAxis tickFormatter={formatYAxisValue} tick={{ fontSize: 11 }} stroke="#666" />
              <Tooltip content={<CustomTooltip />} />

              {/* Cost Basis - Orange Bars */}
              <Bar dataKey="costBasis" fill="#fb923c" name="Cost Basis" radius={[0, 0, 0, 0]} />
