      ...
      <PremiumCard>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center space-x-4 flex-1">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 w-64 border-pov-gray focus:ring-pov-beige font-poppins"
              />
            </div>

            <Select value={filterStatus} onValueChange={setFilterStatus}>
              <SelectTrigger className="w-32 border-pov-gray font-poppins">
            ...
            <Select value={filterSector} onValueChange={setFilterSector}>
              <SelectTrigger className="w-40 border-pov-gray font-poppins">
          ...
          <div className="flex items-center space-x-3">
            <Button variant="outline" size="sm" className="border-pov-gray hover:bg-pov-charcoal hover:text-pov-white font-poppins">
              <Download className="h-4 w-4 mr-2" />
              Export
            </Button>
            <Button size="sm" className="bg-pov-charcoal hover:bg-pov-charcoal/90 text-pov-white font-poppins">
      ...
      >
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-pov-beige">
                <th className="text-left py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Company</th>
                <th className="text-left py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Sector</th>
                <th className="text-left py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Status</th>
                <th className="text-right py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Investment</th>
                <th className="text-right py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Current Value</th>
                <th className="text-right py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">MOIC</th>
                <th className="text-center py-4 px-2 font-inter font-bold text-sm text-pov-charcoal">Actions</th>
              </tr>
            </thead>
            <tbody>
              {filteredCompanies.map((company) => (
                <tr key={company.id} className="border-b border-pov-beige hover:bg-pov-beige/20 transition-colors">
