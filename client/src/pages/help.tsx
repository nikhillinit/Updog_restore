            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Button variant="link" className="p-0 h-auto text-pov-charcoal" disabled>
          ...
          <CardContent>
            <div className="flex items-center justify-between p-4 rounded-lg bg-pov-gray">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-inter text-sm font-medium text-pov-charcoal">Email Support</p>
                  <p className="font-poppins text-xs text-presson-textMuted">
                    {BRANDING.contact.support}
                  </p>
                </div>
              </div>
              <Button asChild className="bg-pov-charcoal hover:bg-pov-charcoal/90 text-pov-white">
                <a href={`mailto:${BRANDING.contact.support}`}>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="font-poppins text-sm">Product updates</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <p className="font-poppins text-sm text-charcoal-600">
              Release notes are not available in this workspace.
            </p>
          </CardContent>
        </Card>
      </div>
