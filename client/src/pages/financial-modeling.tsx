            ...
            <TabsContent value="modeling">
              <Card>
                ...
                <CardContent className="space-y-4 text-sm text-muted-foreground">
                  ...
                  <p>
                    Additional scenario-modeling and reserve-analysis work remains queued until
                    those sections can be backed by authoritative inputs instead of placeholder
                    content.
                  </p>
                </CardContent>
              </Card>
