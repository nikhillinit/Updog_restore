...
export default function ReturnTheFundPage() {
  ...
  const seriesAOwnership: OwnershipData[] = [
    ...
    { round: 'Series D', ownership: 7.6, returnTheFund: 1974 },
  ...
  const selectedInvestmentData =
    investments.find((inv) => inv.id === selectedInvestment)?.data || seriesAOwnership;

  const currentReserve = reserveAmount[0] ?? 0;
  const selectedData =
    returnTheFundData.find((item) => item.investmentAmount === currentReserve) ??
    returnTheFundData[5] ??
    FALLBACK_RETURN_THE_FUND_DATA;
      ...
      <Card className="border-blue-200 bg-blue-50">
        ...
        <CardContent>
          <p className="text-blue-800">
            <strong>Return the Fund</strong> is a common analysis managers undertake when evaluating
            venture deals. This involves calculating a Return the Fund metric - the aggregate
            valuation a company needs to achieve in order to pay back the entire fund. A "Fund
            Returner" is a single deal that achieves this threshold.
          </p>
        </CardContent>
      </Card>
        ...
        <TabsContent value="construction" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select an investment type to view how ownership dilutes and Return the Fund changes
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <Label htmlFor="investment-select">
                    Select an investment for the charts below:
                  </Label>
                      ...
                      <div className="h-80">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={selectedInvestmentData}>
                            ...
                            <XAxis dataKey="round" />
                            <YAxis domain={[0, 0.125]} tickFormatter={formatOwnershipTick} />
                            <Tooltip formatter={formatOwnershipTooltip} />
                      ...
                      <div className="h-80">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={selectedInvestmentData}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis dataKey="round" />
                            <YAxis tickFormatter={formatReturnTheFundTick} />
                            <Tooltip formatter={formatReturnTheFundTooltip} />
                            <Bar dataKey="returnTheFund" fill="#10b981" name="Return the Fund" />
                          </BarChart>
                        </ResponsiveContainer>
                      </div>
                    </CardContent>
                ...
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Key Insight:</strong> As the fund's ownership dilutes over subsequent
                    rounds, Return the Fund increases. This can be helpful in setting future
                    reserves to keep this metric in check.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>
                  Select a specific investment's performance case to view the Return the Fund
                  profile
                </p>
        ...
        <TabsContent value="reserves" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                What is the optimal follow-on investment in the {selectedRound.replace('-', ' ')}{' '}
                round?
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <Card className="p-4">
                    ...
                    <div className="text-xl font-bold">
                      {selectedData.resultingOwnership.toFixed(2)}%
                    </div>
                  </Card>
                          ...
                          {returnTheFundData.slice(0, 8).map((row) => (
                            <tr
                              ...
                              className={`border-b hover:bg-gray-50 ${
                                row.investmentAmount === currentReserve
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>Optimization Insight:</strong> As reserves increase, Return the Fund
                    decreases. Managers can use this as a guide to optimize their reserve for a
                    particular deal while maintaining target fund return thresholds.
                  </p>
                </div>
              </div>
            </CardContent>
