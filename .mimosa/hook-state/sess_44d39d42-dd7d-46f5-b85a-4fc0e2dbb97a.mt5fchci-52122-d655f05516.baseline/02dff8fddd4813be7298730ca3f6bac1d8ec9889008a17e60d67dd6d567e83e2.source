...
export const varianceTrackingFixtures = {
  ...
  baselines: {
    quarterly: {
      ...
      top_performers: {
        companies: [
          { id: 1, name: 'TechCorp Alpha', valuation: 500000.0, growth: 0.25 },
          { id: 2, name: 'HealthTech Beta', valuation: 400000.0, growth: 0.18 },
          { id: 3, name: 'FinTech Gamma', valuation: 350000.0, growth: 0.15 },
        ],
      },
      sector_distribution: {
        Technology: 0.35,
      ...
      reserve_allocation: {
        ...
        allocatedReserves: 350000.0,
        availableReserves: 150000.0,
        reserveRatio: 0.2,
      },
      pacing_metrics: {
        deploymentRate: 0.8,
    ...
    annual: {
      ...
      top_performers: {
        companies: [
          { id: 1, name: 'TechCorp Alpha', valuation: 500000.0, growth: 0.45 },
          { id: 2, name: 'HealthTech Beta', valuation: 400000.0, growth: 0.38 },
        ],
      },
      sector_distribution: {
        Technology: 0.38,
      ...
      reserve_allocation: {
        totalReserves: 500000.0,
        allocatedReserves: 400000.0,
        availableReserves: 100000.0,
        reserveRatio: 0.2,
      },
      pacing_metrics: {
        deploymentRate: 0.8,
    ...
    milestone: {
      ...
      top_performers: {
        companies: [
          { id: 1, name: 'TechCorp Alpha', valuation: 600000.0, growth: 0.3 },
          { id: 4, name: 'AI Innovations', valuation: 500000.0, growth: 0.0 }, // New investment
        ],
      },
      sector_distribution: {
        Technology: 0.4,
      ...
      reserve_allocation: {
        totalReserves: 550000.0,
        allocatedReserves: 450000.0,
        availableReserves: 100000.0,
        reserveRatio: 0.2,
      },
      pacing_metrics: {
  ...
  reports: {
    periodicReport: {
      baselineId: 'test-baseline-uuid', // Resolved by route or passed explicitly
      reportName: 'December 2024 Variance Analysis',
      reportType: 'periodic' as const,
      reportPeriod: 'monthly',
      asOfDate: '2024-12-31T23:59:59Z',
      currentMetrics: {
        totalValue: 2650000.0,
        deployedCapital: 2100000.0,
        irr: 0.172,
        multiple: 1.48,
        dpi: 0.94,
        tvpi: 1.39,
        ...
        companyVariances: [
          {
            ...
            valuationVariance: 50000.0,
            valuationVariancePct: 0.1,
            riskLevel: 'low',
          },
          {
            companyId: 5,
            companyName: 'Legacy Corp',
            valuationVariance: -25000.0,
  ...
  alertRules: {
    ...
    totalValueCriticalRule: {
      ...
      escalationRules: {
        levels: [
          { threshold: -0.1, delay: 0, notify: ['portfolio_manager'] },
          { threshold: -0.15, delay: 30, notify: ['portfolio_manager', 'gp'] },
          { threshold: -0.2, delay: 60, notify: ['portfolio_manager', 'gp', 'board'] },
        ],
      },
    },
  ...
  alerts: {
    irrDeclineAlert: {
      ...
      context_data: {
        ...
        contributingFactors: ['Market downturn in consumer sector', 'Delayed Series A rounds'],
      },
      escalation_level: 0,
      rule_version: '1.0.0',
    },
    ...
    resolvedAlert: {
      ...
      resolution_notes:
        'Diversification targets achieved through recent investments in healthcare and fintech sectors.',
      escalation_level: 0,
      rule_version: '1.0.0',
    },
  },
  ...
  scenarios: {
    majorPortfolioChange: {
      ...
      before: {
        ...
        portfolioCount: 18,
        companies: [
          { id: 1, name: 'TechCorp', valuation: 500000.0 },
          { id: 2, name: 'ExitCorp', valuation: 400000.0 }, // Will exit
        ],
      },
      after: {
        ...
        portfolioCount: 18,
        companies: [
          { id: 1, name: 'TechCorp', valuation: 600000.0 }, // Grew
          { id: 3, name: 'NewCorp', valuation: 500000.0 }, // New investment
        ],
      },
      expectedVariances: {
        totalValueVariance: 300000.0,
        portfolioCountVariance: 0,
        exitCount: 1,
    ...
    strongPerformance: {
      ...
      expectedVariances: {
        totalValueVariance: 700000.0,
        totalValueVariancePct: 0.28,
        irrVariance: 0.06,
        multipleVariance: 0.4,
        tvpiVariance: 0.34,
      },
...
export const varianceTestHelpers = {
  ...
  generateVarianceReport(baseline: any, varianceLevel: 'low' | 'medium' | 'high' = 'medium'): any {
    ...
    return {
      ...
      total_value_variance_pct:
        (currentValue - parseFloat(baseline.total_value)) / parseFloat(baseline.total_value),
  ...
  generateAlert(variance: any, severity: 'info' | 'warning' | 'critical' = 'warning'): any {
    return {
      ...
      metric_name:
        Math.abs(variance.irr_variance || 0) > Math.abs(variance.total_value_variance_pct || 0)
          ? 'irr'
          : 'totalValue',
      threshold_value: severity === 'critical' ? -0.1 : severity === 'warning' ? -0.05 : -0.02,
