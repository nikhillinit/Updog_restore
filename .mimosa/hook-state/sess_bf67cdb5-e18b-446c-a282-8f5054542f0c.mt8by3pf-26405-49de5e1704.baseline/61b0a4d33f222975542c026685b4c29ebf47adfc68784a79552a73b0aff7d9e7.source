 ...
 * from `@shared/schema`, mirror the canonical journal (0014) through
 * getTableConfig shape assertions, and declare the documented CHECK
 * constraints. Catches barrel/import
