  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="relative mb-6">
        <div className="h-3 bg-pov-gray rounded-full overflow-hidden">
          <div
            className="h-3 bg-gradient-to-r from-charcoal-600 to-pov-charcoal rounded-full transition-all duration-300 ease-out shadow-sm"
          ...
          return (
            ...
            >
                ...
                ${
                  isCompleted
                    ...
                    : isCurrent
                      ...
                      : isPast
                        ? 'bg-pov-gray border-charcoal-300 text-charcoal-500'
                        : 'bg-pov-white border-charcoal-300 text-charcoal-400'
                }
              `}
              >
                {isCompleted ? (
              ...
              <div className="min-h-[3rem] flex flex-col">
                <h4
                  className={`font-inter font-semibold text-xs mb-1 transition-colors duration-200 ${
                ...
                <p
                  className={`font-poppins text-xs leading-tight transition-colors duration-200 ${
