...
CREATE TABLE IF NOT EXISTS "portfolio_company_update_receipts" (
  ...
  "response_fund_id" integer NOT NULL,
  "response_name" varchar(255) NOT NULL,
  "response_sector" varchar(255) NOT NULL,
  "response_stage" text NOT NULL,
  "response_current_stage" text,
  "response_investment_amount" numeric(15, 2) NOT NULL,
  "response_investment_date" timestamp,
  "response_current_valuation" numeric(15, 2),
  "response_founded_year" integer,
  "response_company_status" text NOT NULL,
  "response_description" varchar(2000),
  "response_deal_tags" jsonb,
  "response_created_at" timestamp,
  "response_deployed_reserves_cents" bigint,
  "response_planned_reserves_cents" bigint,
  "response_exit_moic_bps" integer,
  "response_exit_probability" numeric(7, 6),
  "response_ownership_current_pct" numeric(7, 4),
  "response_allocation_cap_cents" bigint,
  "response_allocation_reason" text,
  "response_allocation_iteration" integer NOT NULL,
  "response_last_allocation_at" timestamp with time zone,
  "response_allocation_version" integer NOT NULL,
