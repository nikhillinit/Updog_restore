 ...
 */
export function parseStageDistribution(entries: StageDistributionEntry[]): ParseResult {
  // Validate non-empty
 ...
 */
export function createUniformDistribution(stages: string[]): NormalizedStageDistribution[] {
