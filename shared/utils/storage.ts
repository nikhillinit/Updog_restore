...
type GlobalMemoryStorageState = typeof globalThis & { __memoryStorage?: MemoryStorage };
const globalStorageState = globalThis as GlobalMemoryStorageState;
let globalMemoryStorage: MemoryStorage | undefined = globalStorageState.__memoryStorage;
...
export function getStorage(type: 'local' | 'session' = 'local'): KV {
  ...
  if (!globalMemoryStorage) {
    ...
    globalStorageState.__memoryStorage = globalMemoryStorage;
  }
