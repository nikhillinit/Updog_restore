...
export type MigrationParity =
  { kind: 'c1'; tables: readonly string[] } | { kind: 'other-table' } | { kind: 'non-table' };
...
export interface CommonApiRouteManifestEntry {
  ...
  fundScope: FundScope;
  financial: boolean;
  migrationParity: MigrationParity;
...
export const COMMON_API_ROUTE_MANIFEST = [
  ...
  {
    id: 'financial-facts',
    sourceModule: './routes/financial-facts.js',
    mountPath: '/api',
    authBoundary: 'router_local',
    fundScope: 'path',
    financial: true,
    migrationParity: { kind: 'c1', tables: ['financial_facts_snapshots'] },
    schemaTables: [
    ...
    probe: {
      method: 'GET',
      path: '/api/funds/abc/financial-facts/latest',
      expectedStatus: 400,
      authenticated: true,
    },
  },
  {
    ...
    probe: {
      method: 'GET',
      path: '/api/funds/abc/current-plan-versions',
      expectedStatus: 400,
      authenticated: true,
    },
  },
  ...
  },
  {
    ...
    fundScope: 'router_defined',
    financial: true,
    migrationParity: { kind: 'c1', tables: ['investment_rounds'] },
  ...
  },
  {
    ...
    fundScope: 'none',
    financial: true,
    migrationParity: { kind: 'non-table' },
    schemaTables: [],
    owner: 'analytics',
    probe: {
      method: 'POST',
  ...
  },
  {
    ...
    fundScope: 'path',
    financial: true,
    migrationParity: { kind: 'c1', tables: ['cash_flow_events'] },
  ...
  },
  {
    ...
    fundScope: 'router_defined',
    financial: true,
    migrationParity: { kind: 'c1', tables: ['vehicles', 'valuation_marks'] },
    schemaTables: [
      'limited_partners',
      'lp_fund_commitments',
      'capital_activities',
  ...
  },
  {
    ...
    fundScope: 'path',
    financial: true,
    migrationParity: { kind: 'c1', tables: ['lp_metric_runs', 'narrative_runs'] },
    schemaTables: [
      'cash_flow_events',
      'valuation_marks',
      'lp_metric_runs',
...
export type FinancialCommonApiRouteId = Extract<
  (typeof COMMON_API_ROUTE_MANIFEST)[number],
  { financial: true }
>['id'];
