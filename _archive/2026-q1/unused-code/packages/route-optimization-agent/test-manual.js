...
async function runTests() {
  ...
  test('should create an instance of RouteOptimizationAgent', () => {
    ...
    assert(
      agent instanceof RouteOptimizationAgent,
      'Agent should be instance of RouteOptimizationAgent'
    );
  });
  ...
  test('should have correct default configuration', () => {
    ...
    assertEquals(
      ...
      'Agent name should be RouteOptimizationAgent'
    );
  ...
  test('should execute with minimal input', async () => {
    ...
    try {
      ...
      console.log(
        '  Note: Execution failed (expected if routes directory missing):',
        error.message
      );
    }
  });
