  ...
  describe('Prediction Generation', () => {
    ...
    describe('Exponential Smoothing Model', () => {
      it('should handle volatile time series data', async () => {
        ...
        const volatileData = mockHistoricalData.map((data) => ({
          ...data,
    ...
    describe('Polynomial Regression Model', () => {
      it('should handle non-linear patterns', async () => {
        ...
        const quadraticData = mockHistoricalData.map((data, _index) => ({
          ...data,
          irr: 0.1 + 0.02 * _index + 0.001 * _index * _index,
        }));
  ...
  describe('Trend Analysis', () => {
    describe('analyzeTrends', () => {
      ...
      it('should identify downward trends', async () => {
        ...
        const decliningData = mockHistoricalData.map((data, _index) => ({
          ...data,
          irr: 0.3 - 0.02 * _index, // Declining IRR
        }));
