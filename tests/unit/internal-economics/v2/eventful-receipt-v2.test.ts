...
describe('F3b eventful receipt contract', () => {
  it('certifies both lanes and binds lane-correct 2.4.0 receipts', () => {
    ...
    expect(deal.receiptVersion).toBe('internal-economics-receipt/2.4.0');
    expect(whole.receiptVersion).toBe('internal-economics-receipt/2.4.0');
    ...
    expect(deal.componentVersions.composite).toBe('internal-economics-composite/2.4.0');
    expect(whole.componentVersions.eventEngine).toBe('internal-economics-event-engine/2.4.0');
  });
