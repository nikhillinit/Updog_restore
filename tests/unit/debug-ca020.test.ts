...
describe('Debug CA-020', () => {
  it('should handle integration case correctly', () => {
    ...
    console.log('April alloc:', apr?.allocationCents, 'cohorts:', apr ? Object.fromEntries(apr.allocationsByCohort) : {});
    console.log('May alloc:', may?.allocationCents, 'cohorts:', may ? Object.fromEntries(may.allocationsByCohort) : {});
    console.log('Total:', result.allocations_by_cohort);
    console.log('Expected: A: 2500000, B: 2500000');
  });
});
