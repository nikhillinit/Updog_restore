...
describe('database-backed idempotency route classification', () => {
  it.each([
    ...
    ['POST', '/api/investments/41/rounds'],
    ['POST', '/api/INVESTMENTS/41/ROUNDS/?source=rail#command'],
  ...
  it.each([
    ...
    ['GET', '/api/investments/41/rounds'],
    ['post', '/api/investments/41/rounds'],
    ['POST', '/api/investments/41/rounds/extra'],
    ['POST', '/prefix/api/investments/41/rounds'],
