export const TESTCONTAINERS_TEST_PATHS = Object.freeze([
  ...
  'tests/integration/prod-schema-capital-plan-override.test.ts',
  'tests/integration/fund-scenario-capital-persistence.test.ts',
  'tests/integration/fund-scenario-capital-recovery.test.ts',
  'tests/integration/fund-scenario-capital-limits.test.ts',
