 ...
 * - Graceful shutdown
 *
 * Uses Testcontainers for PostgreSQL + Redis setup
 */
...
describe.skipIf(!dockerAvailable)('ScenarioGenerator Worker Integration', () => {
  ...
  beforeAll(async () => {
    ...
    db = drizzle(pgConnectionString, { schema });
