...
> Auto-generated on 2026-01-14 - DO NOT EDIT MANUALLY Run
> `npm run quarantine:report` to regenerate
...
| tests\integration\scenario-comparison.test.ts                          | 1     | Yes        | Database migration required - tables not deployed to production                    | nikhil | Run npm run db:push after product approval, enable feature flag            |
...
| tests\integration\_\_tests\_\_\vite-build-regression.test.ts           | 1     | No         | -                                                                                  | -      | -                                                                          |
| tests\integration\_\_tests\_\_\golden-dataset-regression.test.ts       | 1     | No         | -                                                                                  | -      | -                                                                          |
| client\src\core\capitalAllocation\_\_tests\_\_\truthCaseRunner.test.ts | 1     | No         | -                                                                                  | -      | -                                                                          |
