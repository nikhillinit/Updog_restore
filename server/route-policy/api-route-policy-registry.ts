...
const GOVERNANCE_ROUTE_POLICY_DECISIONS: Readonly<Record<string, RoutePolicyDecision>> = {
  ...
  '/fund-model-results/:fundId/operations': {
    lifecycle: 'durable_crud',
    financialSurface: 'fund_modeling',
    apiAuthBoundary: 'require_auth_and_fund_access',
    fundScopeMode: 'route_param_fund_id',
...
export const EXPLICIT_API_ROUTE_POLICY_ENTRIES: RoutePolicyEntry[] = [
  ...
  },
  {
    ...
    surface: 'portfolio-companies-api',
    owner: ownerForFinancialSurface('portfolio_management'),
    telemetryKey: telemetryKeyForRoute('api.route', '/api/portfolio-companies'),
    financialSurface: 'portfolio_management',
    ...
    humanReviewRequired: true,
    performanceBudgetMs: null,
    notes: 'Portfolio company creation requires team write role and verified fund scope.',
  },
  {
    id: 'api:patch:/api/portfolio-companies/:id',
    method: 'PATCH',
    path: '/api/portfolio-companies/:id',
    lifecycle: 'durable_crud',
    governanceRef: '/portfolio/company/:id',
    surface: 'portfolio-companies-api',
    owner: ownerForFinancialSurface('portfolio_management'),
    telemetryKey: telemetryKeyForRoute('api.route', '/api/portfolio-companies/:id'),
    financialSurface: 'portfolio_management',
    apiAuthBoundary: 'require_auth_fund_access_and_role',
    fundScopeMode: 'query_param_fund_id',
    workflowRequirement: 'fund_scope_and_idempotency_verified',
    ...
    humanReviewRequired: true,
    performanceBudgetMs: null,
    notes: 'Metadata-only PATCH uses durable idempotency receipts and row-version CAS.',
  },
  {
    id: 'api:put:/api/lp/settings',
    method: 'PUT',
    path: '/api/lp/settings',
    lifecycle: 'durable_crud',
    governanceRef: '/lp/settings',
    surface: 'lp-api',
    owner: ownerForFinancialSurface('lp_reporting'),
    telemetryKey: telemetryKeyForRoute('api.route', '/api/lp/settings'),
    financialSurface: 'lp_reporting',
    apiAuthBoundary: 'require_auth_and_lp_access',
    fundScopeMode: 'lp_claim_scope',
    workflowRequirement: 'lp_settings_write_blocked',
    exportPolicy: 'not_exportable',
    provenanceRequired: false,
    staleBlocksExport: false,
    humanReviewRequired: true,
  ...
  {
    id: 'api:post:/api/funds/:fundId/current-forecast/recompute',
    method: 'POST',
    path: '/api/funds/:fundId/current-forecast/recompute',
    lifecycle: 'durable_crud',
    governanceRef: '/fund-model-results/:fundId/operations',
    surface: 'current-forecast-recompute-api',
    owner: ownerForFinancialSurface('fund_modeling'),
    telemetryKey: telemetryKeyForRoute(
      'api.route',
    ...
    humanReviewRequired: true,
    performanceBudgetMs: null,
    notes: 'Issue #1293. Durable manual current-forecast recompute command.',
  },
  {
  ...
  {
    id: 'api:post:/api/funds/:fundId/construction-reconciliation/runs',
    method: 'POST',
    path: '/api/funds/:fundId/construction-reconciliation/runs',
    lifecycle: 'durable_crud',
    governanceRef: '/fund-model-results/:fundId',
    surface: 'construction-reconciliation-api',
    owner: ownerForFinancialSurface('fund_modeling'),
    telemetryKey: telemetryKeyForRoute(
      'api.route',
    ...
    performanceBudgetMs: null,
    notes:
      'Idempotent fund-scoped construction reconciliation write pins current plan and facts snapshots.',
  },
  {
    id: 'api:get:/api/funds/:fundId/construction-reconciliation/latest',
    method: 'GET',
    path: '/api/funds/:fundId/construction-reconciliation/latest',
    lifecycle: 'durable_crud',
    governanceRef: '/fund-model-results/:fundId',
    surface: 'construction-reconciliation-api',
    owner: ownerForFinancialSurface('fund_modeling'),
  ...
  {
    id: 'api:post:/api/admin/funds/:fundId/calculation-modes/current-forecast/resume',
    method: 'POST',
    path: '/api/admin/funds/:fundId/calculation-modes/current-forecast/resume',
    lifecycle: 'durable_crud',
    governanceRef: '/fund-model-results/:fundId',
    surface: 'current-forecast-resume-admin-api',
    owner: 'analytics',
    telemetryKey: telemetryKeyForRoute(
      'api.route',
      '/api/admin/funds/:fundId/calculation-modes/current-forecast/resume'
    ),
    // TODO(13): replace with a current_forecast surface when the policy type supports it.
    financialSurface: 'moic_reserves',
    apiAuthBoundary: 'admin_only',
    ...
    performanceBudgetMs: null,
    notes:
      'Idempotent post-activation recovery command: clears held controls without advancing or rolling back the served pointer.',
  },
  {
  ...
  ...(
    [
      [
        ...
        'Create one fund-scoped operating decision under required Idempotency-Key.',
      ],
      ['GET', '/api/funds/:fundId/decisions', 'List operating decisions for one fund.'],
      [
        'GET',
        '/api/funds/:fundId/decisions/:decisionId',
        'Read one decision; response ETag must echo in If-Match.',
      ],
      [
        'PATCH',
        '/api/funds/:fundId/decisions/:decisionId',
        'Transition one decision under If-Match optimistic locking.',
      ],
      [
        'POST',
        '/api/funds/:fundId/decisions/:decisionId/outcome',
        'Record one immutable decision outcome under If-Match optimistic locking.',
      ],
      [
        'POST',
        '/api/funds/:fundId/decisions/:decisionId/supersede',
        'Create one successor decision under required Idempotency-Key.',
      ],
      [
        'GET',
        '/api/funds/:fundId/decisions/:decisionId/evidence-links',
        'List evidence links for one decision.',
      ],
      [
        'POST',
        '/api/funds/:fundId/decisions/:decisionId/evidence-links',
        'Create one immutable decision evidence link under required Idempotency-Key.',
      ],
    ] as const
  ).map(([method, path, notes]): RoutePolicyEntry => ({
    id: `api:${method.toLowerCase()}:${path}`,
    ...
    lifecycle: 'durable_crud',
    governanceRef: '/portfolio',
    surface: 'operating-object-decisions-api',
    owner: ownerForFinancialSurface('portfolio_management'),
    telemetryKey: telemetryKeyForRoute('api.route', path),
    financialSurface: 'portfolio_management',
    apiAuthBoundary: 'require_auth_and_fund_access',
...
export const COMMON_API_ROUTE_POLICY_IDS = {
  ...
  'current-forecast': [
    ...
    'api:post:/api/funds/:fundId/current-forecast/recompute',
    'api:put:/api/admin/funds/:fundId/calculation-modes/current-forecast',
    'api:post:/api/admin/funds/:fundId/calculation-modes/current-forecast/resume',
  ...
  'construction-reconciliation': [
    'api:post:/api/funds/:fundId/construction-reconciliation/runs',
    'api:get:/api/funds/:fundId/construction-reconciliation/latest',
  ],
