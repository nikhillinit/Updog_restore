...
const columnsWithXmin = {
  ...
  importedFrom: investmentRounds.importedFrom,
  vehicleParticipationId: investmentRounds.vehicleParticipationId,
  financingTrancheId: investmentRounds.financingTrancheId,
