---
description: Retired production-action authority pointer
...
target scope, existing target identity when one exists, and applicable recovery
evidence. Schema/data action additionally requires restore-reference
revalidation, managed backup/PITR, isolated restore freshness, custody roles,
and preview/restore isolation.
