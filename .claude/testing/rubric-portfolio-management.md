...
This rubric covers portfolio company management, investment tracking, cap table calculations, and company lifecycle management.
...
**Objective:** Verify company creation with required fields
**Steps:**
...
**Objective:** Verify company form validation rules
**Steps:**
...
**Objective:** Verify initial investment event creation
**Steps:**
...
**Objective:** Verify follow-on investment tracking and dilution
**Steps:**
...
**Objective:** Verify exit tracking and return calculations
**Steps:**
...
**Objective:** Verify cap table calculations and dilution tracking
**Steps:**
...
**Objective:** Verify company status transitions and constraints
**Steps:**
...
**Objective:** Verify notes and audit trail functionality
**Steps:**
...
**Objective:** Verify portfolio filtering, sorting, and search
**Steps:**
...
**Objective:** Verify bulk actions on multiple companies
**Steps:**
...
- [cheatsheets/cap-table-modeling.md](../../cheatsheets/cap-table-modeling.md) - Cap table calculation patterns
- [shared/schemas/portfolio.schemas.ts](../../shared/schemas/portfolio.schemas.ts) - Validation schemas
