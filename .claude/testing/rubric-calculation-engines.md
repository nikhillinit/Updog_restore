...
**Domain:** Financial calculations (XIRR, waterfall, Monte Carlo, reserves,
pacing) **Estimated Time:** 75 minutes **Prerequisites:** Test fund with
investments, Excel reference files

---

## Overview

This rubric covers all financial calculation engines that power the platform's
analytical capabilities. These engines have **Excel parity requirements** - all
calculations must match Excel outputs exactly.

**Calculation Engines:**

1. **XIRR Calculator** - Internal rate of return (51 tests passing)
2. **Waterfall Calculator** - American waterfall distributions (53 tests
   passing)
...
**Objective:** Verify XIRR calculations match Excel XIRR function **Steps:**
...
4. Verify calculation matches Excel:
   `=XIRR({-1000000, 1200000}, {2024-01-01, 2024-12-31})`
...
**Objective:** Verify XIRR handles edge cases correctly **Steps:**
...
**Objective:** Verify American waterfall distributions match Excel **Steps:**
...
**Objective:** Verify waterfall handles complex scenarios **Steps:**
...
**Objective:** Verify Monte Carlo simulations run and produce valid
distributions **Steps:**
...
**Objective:** Verify sensitivity analysis across scenarios **Steps:**
...
**Objective:** Verify reserve allocation rules execute correctly **Steps:**
...
**Objective:** Verify ML-driven reserve suggestions **Steps:**
...
**Objective:** Verify investment pacing calculations **Steps:**
...
**Objective:** Verify cohort analysis calculations **Steps:**
...
**Objective:** Verify scenario comparison delta calculations (from MVP
...
**Objective:** Verify all engines use consistent precision (Decimal.js, 28
digits) **Steps:**
...
- [.claude/agents/xirr-fees-validator.md](../agents/xirr-fees-validator.md) -
  XIRR/fees validation agent
- [.claude/agents/waterfall-specialist.md](../agents/waterfall-specialist.md) -
  Waterfall semantics agent
- [shared/utils/scenario-math.ts](../../shared/utils/scenario-math.ts) - Core
  math utilities
- [server/services/comparison-service.ts](../../server/services/comparison-service.ts) -
