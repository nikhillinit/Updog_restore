...
**Domain:** Security, performance, accessibility, error handling, browser
compatibility **Estimated Time:** 55 minutes **Prerequisites:** Multiple
browsers, accessibility tools, performance monitoring

---

## Overview

This rubric covers cross-cutting concerns that apply across all platform
features. These are non-functional requirements critical to production
readiness.
...
**Objective:** Verify secure authentication and session management **Steps:**
...
**Objective:** Verify role-based access control across UI and API **Steps:**
...
**Objective:** Verify all user inputs validated and sanitized **Steps:**
...
**Objective:** Verify sensitive data encrypted and protected **Steps:**
...
**Objective:** Verify pages load within performance budgets **Steps:**
...
**Objective:** Verify API endpoints respond within targets **Steps:**
...
**Objective:** Verify BullMQ jobs execute within timeout **Steps:**
...
**Objective:** Verify full keyboard accessibility (WCAG 2.1 AA) **Steps:**
...
**Objective:** Verify screen reader announces all content **Steps:**
...
**Objective:** Verify errors caught and displayed gracefully **Steps:**
...
3. Verify user-friendly error: "Unable to connect. Please check your internet
   connection."
...
**Objective:** Verify app works in all major browsers **Steps:**
...
**Objective:** Verify app responsive on mobile/tablet **Steps:**
...
- [.claude/skills/owasp-security/SKILL.md](../skills/owasp-security/SKILL.md) -
  Security guidelines
- [cheatsheets/react-performance-patterns.md](../../cheatsheets/react-performance-patterns.md) -
  Performance tips
- [DECISIONS.md](../../DECISIONS.md) - Architecture decisions impacting
