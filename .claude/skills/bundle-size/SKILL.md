...
See [references/capability-tiers.md](references/capability-tiers.md) for
details.
...
> "To identify package-level contribution, open dist/stats.html for an
> interactive treemap, or enable Rollup stats output in vite.config.ts for
...
WARNING: This increases build time. Only enable if package attribution is
regularly needed.
