...
This directory contains real-world examples showing how the 3-file planning
pattern works in practice.

## Example: Building a Todo App

This walkthrough demonstrates a complete task from start to finish, showing how
`task_plan.md`, `findings.md`, and `progress.md` evolve together.

### The Task

**User Request:** "Build a simple command-line todo app in Python that can add,
...
- [examples.md](../skills/planning-with-files/examples.md) - Additional patterns
  and use cases

---

_Want to contribute an example? Open a PR!_
