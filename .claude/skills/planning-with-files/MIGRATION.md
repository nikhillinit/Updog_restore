...
Version 2.0.0 adds hooks integration and enhanced templates while maintaining
...
**Benefit:** You no longer need to manually remember to re-read your plan. The
...
Your existing `task_plan.md` files will continue to work. The hooks look for
this file and gracefully handle its absence.
...
The new format enables the `check-complete.sh` script to automatically verify
completion.
