...
- **Location**: `server/db/migrations/*.sql` and
  `server/db/migrations/rollback/*.sql`
...
- **RLS Enforcement**: Request-scoped transactions with
...
- [RLS Implementation](./RLS-DEVELOPMENT-GUIDE.md)
- [API Development](./api/patterns/existing-route-patterns.md)
