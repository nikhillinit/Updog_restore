...
1. **Standalone Vercel-function path omitted `/api` prefix** —
   [matrix.json:10](../../audit/surface-contract-matrix/matrix.json),
   [source-inventory.json:5](../../audit/surface-contract-matrix/source-inventory.json).
...
2. **Authorization extraction leaked file-wide roles into unrelated routes** —
   [matrix-schema.mjs:955](../../audit/surface-contract-matrix/matrix-schema.mjs),
   [matrix.json:27827](../../audit/surface-contract-matrix/matrix.json),
   [matrix.json:44615](../../audit/surface-contract-matrix/matrix.json).
...
3. **Evidence-less proposed rows retained stale suggestion-derived personas** —
   [classify-pass.mjs:272](../../audit/surface-contract-matrix/scripts/classify-pass.mjs).
...
4. **Bracket-notation route registrations were invisible to authorization
   scanning** —
   [matrix-schema.mjs:959](../../audit/surface-contract-matrix/matrix-schema.mjs),
   [matrix.json:5178](../../audit/surface-contract-matrix/matrix.json).
...
5. **Runtime route stack classified terminal handlers as guards** —
   [inspect-runtime.mjs:431](../../audit/surface-contract-matrix/scripts/inspect-runtime.mjs).
...
6. **Worker deployment topology and producer triggers were guessed or
   over-attached** —
   [seed-matrix.mjs:797](../../audit/surface-contract-matrix/scripts/seed-matrix.mjs),
   [seed-matrix.mjs:856](../../audit/surface-contract-matrix/scripts/seed-matrix.mjs),
   [matrix.json:52541](../../audit/surface-contract-matrix/matrix.json).
...
7. **Client rows omitted Railway-web deployment exposure** —
   [seed-matrix.mjs:748](../../audit/surface-contract-matrix/scripts/seed-matrix.mjs).
...
8. **Boot proof accepted weak HTTP responses or unrelated processes** —
   [boot-proof.mjs:131](../../audit/surface-contract-matrix/scripts/boot-proof.mjs),
   [boot-proof.mjs:168](../../audit/surface-contract-matrix/scripts/boot-proof.mjs).
...
9. **Empty or partial probe result sets could pass boot polling** —
   [boot-proof.mjs:198](../../audit/surface-contract-matrix/scripts/boot-proof.mjs),
   [boot-proof.mjs:218](../../audit/surface-contract-matrix/scripts/boot-proof.mjs).
...
10. **Railway-web proof used a hard-coded bundle path** —
    [boot-proof.mjs:352](../../audit/surface-contract-matrix/scripts/boot-proof.mjs),
    [boot-proof.mjs:365](../../audit/surface-contract-matrix/scripts/boot-proof.mjs).
...
11. **Orphan state had competing authorities and incomplete rendering** —
    [render-matrix.mjs:59](../../audit/surface-contract-matrix/scripts/render-matrix.mjs),
    [render-matrix.mjs:101](../../audit/surface-contract-matrix/scripts/render-matrix.mjs),
    [validate-matrix.mjs:395](../../audit/surface-contract-matrix/scripts/validate-matrix.mjs).
...
12. **Approval and reseed lifecycle could retain stale sign-off** —
    [matrix-schema.mjs:1732](../../audit/surface-contract-matrix/matrix-schema.mjs).
...
13. **Listener approval wrote the wrong fingerprint field** —
    [approve-matrix.mjs:97](../../audit/surface-contract-matrix/scripts/approve-matrix.mjs).
...
14. **Policy, governance, runtime-manifest, and queue entries lacked exhaustive
    live mapping** —
    [validate-matrix.mjs:156](../../audit/surface-contract-matrix/scripts/validate-matrix.mjs).
...
15. **WebSocket runtime-manifest entry was not mapped** —
    [seed-matrix.mjs:1461](../../audit/surface-contract-matrix/scripts/seed-matrix.mjs),
    [source-inventory.json:3280](../../audit/surface-contract-matrix/source-inventory.json).
...
16. **Closed-phase gate did not fully protect requirements, off-row state, or
    exposure coverage** —
    [validate-matrix.mjs:285](../../audit/surface-contract-matrix/scripts/validate-matrix.mjs),
    [validate-matrix.mjs:363](../../audit/surface-contract-matrix/scripts/validate-matrix.mjs).
...
17. **`--close-g1` could write a closed artifact before row-integrity
    validation** —
    [validate-matrix.mjs:336](../../audit/surface-contract-matrix/scripts/validate-matrix.mjs),
    [approve-matrix.mjs:153](../../audit/surface-contract-matrix/scripts/approve-matrix.mjs).
...
18. **Removed rows retained stale `coverage_review` keys** —
    [matrix-schema.mjs:1838](../../audit/surface-contract-matrix/matrix-schema.mjs),
    [surface-contract-matrix-merge-discovery.test.ts:278](../../tests/unit/audit/surface-contract-matrix-merge-discovery.test.ts).
...
19. **Knowledge-graph `TESTS` edges were not represented in matrix evidence** —
    [seed-matrix.mjs:1364](../../audit/surface-contract-matrix/scripts/seed-matrix.mjs).
...
20. **Closure and lifecycle fixes lacked refusal/regression fixtures** —
    [surface-contract-matrix.test.ts:300](../../tests/unit/audit/surface-contract-matrix.test.ts),
    [surface-contract-matrix.test.ts:327](../../tests/unit/audit/surface-contract-matrix.test.ts),
    [surface-contract-matrix-merge-discovery.test.ts:278](../../tests/unit/audit/surface-contract-matrix-merge-discovery.test.ts).
...
1. **Approval examples omitted a required row or seam selector** —
   [README.md:70](../../audit/surface-contract-matrix/README.md).
