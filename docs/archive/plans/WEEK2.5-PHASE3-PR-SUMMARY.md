...
| --------------------- | ------------ | --------------- | ---------------------- |
| CapitalAllocationStep | [Done]       | [Done]          | PR #231                |
| ExitRecyclingStep     | [Done]       | [Done]          | PR #231                |
| FeesExpensesStep      | [Done]       | [Done]          | PR #231                |
| **WaterfallStep**     | [Done]       | [Done]          | **This commit**        |
| GeneralInfoStep       | [Blocked]    | N/A             | No optimization needed |
| SectorProfilesStep    | [Blocked]    | N/A             | No optimization needed |
| FundFinancialsStep    | [Blocked]    | N/A             | No optimization needed |
| ScenariosStep         | [Blocked]    | N/A             | No optimization needed |

**Result**: [Done] All wizard steps using `watch()` now have performance
optimization
...
vi.mock('../../../server/db'); // [Blocked] Hoisting violation
```
...
import { db } from '../../../server/db'; // [Done] Import after mock
```
...
**After Fixes**: 32/32 passing [Done]
...
1. [Done] WaterfallStep performance fix + type safety ([a7242229](a7242229))
2. [Done] Windows sidecar elimination ([ce8cbc81](ce8cbc81))
3. [Done] Variance tracking test fixes ([9cc09996](9cc09996))
...
import { db } from '../../../server/db'; // [Done] After mock
```
