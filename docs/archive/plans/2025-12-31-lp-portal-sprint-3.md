...
**Created:** 2025-12-31 **Status:** PLANNING **Rubric:**
`.claude/testing/rubric-lp-portal.md` **Duration:** 2 weeks

---

## Executive Summary

Sprint 3 builds on the Sprint 2 infrastructure (storage, email, PDF/XLSX
generation, report queues) to deliver the core LP-facing functionality: capital
call tracking, distribution history with tax breakdowns, and an enhanced
dashboard with performance metrics and activity feeds.
...
**Priority:** P0 **Test Cases:** TC-LP-003a through TC-LP-003d
...
**Priority:** P0 **Test Cases:** TC-LP-004a through TC-LP-004d
...
**Priority:** P0 **Test Cases:** TC-LP-002a through TC-LP-002c
...
**Priority:** P1 **Test Cases:** TC-LP-005a through TC-LP-005d
...
- `server/services/lp-performance-calculator.ts` - Enhanced performance
  calculations
...
**Priority:** P1 **Test Cases:** TC-LP-006a through TC-LP-006d
...
**Priority:** P1 **Test Cases:** TC-LP-008a through TC-LP-008d
...
- `server/services/lp-notification-dispatcher.ts` - Create notifications on
  events
...
All Sprint 3 implementations MUST comply with the 24 anti-patterns documented in
...
- `tests/e2e/lp-dashboard.spec.ts` - Dashboard rendering (already exists,
  enhance)
