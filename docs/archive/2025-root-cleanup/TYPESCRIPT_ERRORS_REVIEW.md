...
**Line:** 65  
**Error:** TS2322 - Type 'PropsWithoutRef<P> & { "data-testid": string; ref:
ForwardedRef<any>; }' is not assignable to type 'IntrinsicAttributes & P'
...
**Error 1 (Line 250):** TS2322 - Type '{ company_id: string; planned_cents:
number; iteration: number; }[]' missing properties: reason, cap_cents
