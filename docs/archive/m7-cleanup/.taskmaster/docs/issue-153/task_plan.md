...
Refactor `shared/lib/jcurve.ts::computeJCurvePath` to reduce cyclomatic
complexity from ~41 to <=8 per function and function length from ~112 to <=50
lines, while maintaining exact output parity.
