...
- [x] Locate implementation - DISCOVERY: /advise is NOT code, it's
      documentation-driven
- [x] Understand current behavior - Refs in docs/skills/README.md lines 34, 39,
      85
...
- [x] All manage_skills.py commands work from any directory (tested from root,
      client/src, docs/)
- [x] /advise output includes Related Documentation (added to
...
- [x] Documentation updated (forensic docs in
      docs/planning/reflection-remediation/)
