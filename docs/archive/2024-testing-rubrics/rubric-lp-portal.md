...
**Estimated Time:** 40 minutes **Prerequisites:** Test fund with LP accounts,
...
This rubric covers the LP Portal, a dedicated interface for limited partners to
view their investments, capital accounts, and fund performance. LPs have
**restricted access** - they can only see their own data, not other LPs'
information.
...
**Objective:** Verify LP login and session management **Steps:**
...
3. Verify error: "Account locked due to too many failed login attempts. Contact
   support."
...
**Objective:** Verify LP dashboard displays correct account summary **Steps:**
...
**Objective:** Verify capital call tracking and notifications **Steps:**
...
**Objective:** Verify distribution tracking and tax reporting **Steps:**
...
**Objective:** Verify LP-specific performance metrics **Steps:**
...
**Objective:** Verify LPs can access authorized documents **Steps:**
...
**Objective:** Verify LPs can only access their own data **Steps:**
...
**Objective:** Verify LPs receive timely notifications **Steps:**
...
**Objective:** Verify LP Portal works on mobile devices **Steps:**
...
4. Verify can navigate to: Dashboard, Capital Calls, Distributions, Performance,
   Documents
...
**Objective:** Verify session timeout and security controls **Steps:**
...
4. Verify redirect to login with message: "Session expired. Please log in
   again."
...
3. Verify error: "Password must be at least 8 characters with uppercase,
...
- [cheatsheets/lp-portal-architecture.md](../../cheatsheets/lp-portal-architecture.md) -
  LP Portal design
- [server/routes/lp-portal.ts](../../server/routes/lp-portal.ts) - LP API
  endpoints
- [client/src/pages/LPDashboard.tsx](../../client/src/pages/LPDashboard.tsx) -
  LP UI components
