...
type: reflection
id: REFL-008
title: TypeScript Type Inference from Database Schemas
...
components: []
keywords: []
test_file: tests/regressions/REFL-008.test.ts
superseded_by: null
---

# Reflection: TypeScript Type Inference from Database Schemas
