...
| [archive/plans/IMPLEMENTATION-PARITY-INTEGRATION-STRATEGY.md](archive/plans/IMPLEMENTATION-PARITY-INTEGRATION-STRATEGY.md) | Triage decision framework for divergence fixes (archived)                               | When encountering implementation mismatches during hardening |
...
| [archive/plans/COMPREHENSIVE-DIVERGENCE-ASSESSMENT.md](archive/plans/COMPREHENSIVE-DIVERGENCE-ASSESSMENT.md)               | Analysis of 22 recent PRs, divergence patterns (archived)                               | Understanding implementation parity issues                   |
| [archive/plans/FOUNDATION-HARDENING-FEE-ALIGNMENT-REVIEW.md](archive/plans/FOUNDATION-HARDENING-FEE-ALIGNMENT-REVIEW.md)   | Fee-specific divergence analysis (archived)                                             | When working on fee-related code                             |
