...
- [ ] **.claude/commands/retrospective.md** (234 days old)
- [ ] **.claude/commands/session-learnings.md** (234 days old)
- [ ] **.claude/commands/wshobson/deps-audit.md** (234 days old)
- [ ] **.claude/integration-test-execution-summary.md** (234 days old)
- [ ] **.claude/integration-test-final-report.md** (234 days old)
- [ ] **.claude/integration-test-reenable-plan-v2.md** (234 days old)
- [ ] **.claude/plan.md** (255 days old)
- [ ] **.claude/prompts/integration-test-continuation-prompt.md** (234 days old)
- [ ] **.claude/prompts/portfolio-intelligence-timeout-fix.md** (234 days old)
- [ ] **.claude/prompts/week2.5-next-session-kickoff.md** (234 days old)
- [ ] **.claude/prompts/week2.5-phase3-continuation-v10.md** (234 days old)
- [ ] **.claude/prompts/week2.5-phase3-continuation-v2.md** (234 days old)
- [ ] **.claude/prompts/week2.5-phase3-continuation-v3.md** (234 days old)
- [ ] **.claude/prompts/week2.5-phase3-continuation.md** (234 days old)
- [ ] **.claude/prompts/week2.5-phase4-next-steps.md** (234 days old)
- [ ] **.claude/session-summary-portfolio-intelligence-implementation.md** (234 days old)
- [ ] **.claude/sessions/PHASE4-CONTINUATION-KICKOFF.md** (234 days old)
- [ ] **.claude/skills/README.md** (234 days old)
- [ ] **.claude/skills/iterative-improvement.md** (234 days old)
- [ ] **.claude/skills/task-decomposition.md** (234 days old)
- [ ] **.claude/testing/rubric-calculation-engines.md** (234 days old)
- [ ] **.claude/testing/scenario-comparison-manual-test-rubric.md** (234 days old)
- [ ] **.claude/testing/seed-script-remaining-fixes.md** (234 days old)
- [ ] **ANTI_PATTERNS.md** (234 days old)
- [ ] **CHANGELOG.md** (12 days old)
- [ ] **COMPREHENSIVE-WORKFLOW-GUIDE.md** (234 days old)
- [ ] **ITERATION-A-QUICKSTART.md** (234 days old)
- [ ] **MIGRATION-NATIVE-MEMORY.md** (234 days old)
- [ ] **PROMPT_PATTERNS.md** (234 days old)
- [ ] **cheatsheets/baseline-governance.md** (122 days old)
- [ ] **cheatsheets/daily-workflow.md** (160 days old)
- [ ] **cheatsheets/emoji-free-documentation.md** (234 days old)
- [ ] **cheatsheets/pr-merge-verification.md** (157 days old)
- [ ] **cheatsheets/schema-alignment.md** (234 days old)
...
- [ ] **docs/CA-IMPLEMENTATION-PLAN.md** (234 days old)
- [ ] **docs/CA-SEMANTIC-LOCK.md** (234 days old)
- [ ] **docs/DECISIONS.md** (234 days old)
- [ ] **docs/DEVELOPMENT_STRATEGY.md** (234 days old)
- [ ] **docs/MILESTONE-XIRR-PHASE0-COMPLETE.md** (234 days old)
- [ ] **docs/RATE_LIMITING_SUMMARY.md** (234 days old)
- [ ] **docs/VERIFICATION_CHECKLIST.md** (234 days old)
- [ ] **docs/action-plans/CODEX-FIXES-EXECUTION-SUMMARY.md** (234 days old)
- [ ] **docs/action-plans/CODEX-ISSUES-RESOLUTION-PLAN.md** (234 days old)
- [ ] **docs/adr/ADR-008-capital-allocation-policy.md** (234 days old)
- [ ] **docs/api/architecture/portfolio-route-api.md** (234 days old)
- [ ] **docs/api/testing/portfolio-route-test-strategy.md** (234 days old)
- [ ] **docs/behavioral-specs/time-travel-analytics-service-specs.md** (234 days old)
- [ ] **docs/chaos-engineering/README.md** (234 days old)
- [ ] **docs/chaos-engineering/RLS-CHAOS-TESTING-PLAN.md** (234 days old)
- [ ] **docs/deployment/STAGING_DEPLOYMENT_SUMMARY.md** (234 days old)
- [ ] **docs/failure-triage.md** (234 days old)
- [ ] **docs/forecasting/power-law-implementation.md** (234 days old)
- [ ] **docs/foundation/PHASE2-ROADMAP-IMPROVEMENTS.md** (234 days old)
- [ ] **docs/foundation/PHASE2-ROADMAP.md** (234 days old)
- [ ] **docs/foundation/PHASE3-KICKOFF.md** (234 days old)
- [ ] **docs/foundation/PHASE4-KICKOFF.md** (234 days old)
- [ ] **docs/integration/upstash-setup.md** (234 days old)
- [ ] **docs/notebooklm-sources/reserves/01-overview.md** (234 days old)
- [ ] **docs/notebooklm-sources/waterfall.md** (234 days old)
- [ ] **docs/notebooklm-sources/xirr.md** (234 days old)
- [ ] **docs/npm-bin-resolution-investigation.md** (234 days old)
- [ ] **docs/observability/EDITORIAL-V2-CHANGELOG.md** (234 days old)
- [ ] **docs/observability/README.md** (234 days old)
- [ ] **docs/phase0-xirr-analysis-eda20590.md** (234 days old)
- [ ] **docs/phase1-1-1-analysis.md** (234 days old)
- [ ] **docs/phase1-xirr-baseline-heatmap.md** (234 days old)
- [ ] **docs/phase1b-waterfall-evaluator-hardening.md** (234 days old)
- [ ] **docs/processes/CONTRIBUTING.md** (234 days old)
- [ ] **docs/processes/code-review-checklist.md** (234 days old)
- [ ] **docs/references/claude-agent-testing.md** (234 days old)
- [ ] **docs/references/replit.md** (234 days old)
- [ ] **docs/releases/stage-norm-phase5.md** (234 days old)
- [ ] **docs/releases/stage-normalization-v3.4.md** (234 days old)
- [ ] **docs/replit.md** (234 days old)
- [ ] **docs/reviews/CA-IMPLEMENTATION-EVALUATION-FINAL.md** (234 days old)
- [ ] **docs/skills-application-log.md** (234 days old)
...
- [ ] **docs/xirr-consolidation-roadmap.md** (255 days old)
- [ ] **docs/xirr-excel-validation.md** (234 days old)
