...
*Generated: 2025-12-12T21:44:49.545Z*
...
| `docs/PHOENIX-SOT/mcp-tools-guide.md` | Never | 999 | No | Unassigned |
| `docs/PHOENIX-SOT/prompt-templates.md` | Never | 999 | No | Unassigned |
| `docs/PHOENIX-SOT/skills-overview.md` | Never | 999 | No | Unassigned |
| `docs/PR_NOTES/CODACY_JCURVE_NOTE.md` | Never | 999 | No | Unassigned |
| `docs/action-plans/CODEX-FIXES-EXECUTION-SUMMARY.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/action-plans/CODEX-ISSUES-RESOLUTION-PLAN.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/adr/0001-evaluator-metrics.md` | Never | 999 | No | Unassigned |
| `docs/adr/0002-token-budgeting.md` | Never | 999 | No | Unassigned |
| `docs/adr/0003-streaming-architecture.md` | Never | 999 | No | Unassigned |
| `docs/adr/ADR-004-waterfall-names.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/adr/ADR-005-xirr-excel-parity.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/adr/ADR-006-fee-calculation-standards.md` | Never | 999 | No | Unassigned |
| `docs/adr/ADR-007-exit-recycling-policy.md` | Never | 999 | No | Unassigned |
| `docs/adr/ADR-008-capital-allocation-policy.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/adr/ADR-010-monte-carlo-validation-strategy.md` | Never | 999 | No | Unassigned |
| `docs/adr/ADR-011-stage-normalization-v2.md` | Never | 999 | No | Unassigned |
| `docs/adr/ADR-012-mem0-integration.md` | Never | 999 | No | Unassigned |
| `docs/adr/README.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/AGENTS.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/AI_AGENT_BACKTEST_FRAMEWORK.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/ai-optimization/AI_COLLABORATION_GUIDE.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/AI_ORCHESTRATOR_IMPLEMENTATION.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/BACKTEST_QUICKSTART.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/CODEX-REVIEW-AGENT-SETUP.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/CODEX_AGENT_MIGRATION.md` | Never | 999 | No | Unassigned |
| `docs/ai-optimization/MULTI_AI_REVIEW_SYNTHESIS.md` | Never | 999 | No | Unassigned |
| `docs/analysis/perf-watch-memoization-root-cause.md` | Never | 999 | No | Unassigned |
| `docs/analysis/wizard-steps-pattern-analysis.md` | Never | 999 | No | Unassigned |
| `docs/api/fund-allocations-phase1b.md` | Never | 999 | No | Unassigned |
| `docs/auth/RS256-SETUP.md` | Never | 999 | No | Unassigned |
| `docs/behavioral-specs/time-travel-analytics-service-specs.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/chaos/catalog.md` | Never | 999 | No | Unassigned |
| `docs/chaos-engineering/QUICK-REFERENCE.md` | Never | 999 | No | Unassigned |
| `docs/chaos-engineering/README.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/chaos-engineering/RLS-CHAOS-TESTING-PLAN.md` | Never | 999 | YES - verify! | Unassigned |
| `docs/chaos-engineering/RLS-GAME-DAY-RUNBOOK.md` | Never | 999 | No | Unassigned |
| `docs/chaos-engineering/RLS-MONITORING-SPECS.md` | Never | 999 | No | Unassigned |
| `docs/code-review/CODEX-BOT-FINDINGS-SUMMARY.md` | Never | 999 | No | Unassigned |
| `docs/components/NumericInput.md` | Never | 999 | No | Unassigned |
| `docs/components/reallocation-tab-implementation.md` | Never | 999 | No | Unassigned |
| `docs/components/reserve-adapter-integration.md` | Never | 999 | No | Unassigned |
